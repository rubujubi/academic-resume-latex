...
\\
\end{tabular}  &  & \begin{tabular}{@{}rr@{}} \textcolor{titleblue}{\includegraphics[width=0.017\linewidth]{imgs/location(1).pdf}} 171 Carlton Road, Markham, ON, L3R 7L3 &\\
...
\shorterSection{\textcolor{titleblue}{Work Experience}}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Huawei Technologies Canada}{Markham, Canada} {Research Associate - Intelligent Testing Team}{Feb 2024 - now}{
\item{\textbf{Model checking}: Modeled core logic of Huawei's Taurus multi-master Database using P language; uncovered edge cases and reported potential concurrency flaws}

	\textbf{Key skills}: Model checking, P language, Formal verification, Distributed system, Concurrency modeling	  
        \vspace{-5pt}
        


\item{\textbf{LLM for Model-based Testing}: Proposed generation optimizations that improved success rate by 50\% and acceptance rate by 33.4\%; Built an UML evaluation pipeline that achieved 90\% accuracy using LLMs.}

	\textbf{Key skills}: Model-based testing, Test automation, UML, Prompt engineering, Python, LLM evaluation 	  
        \vspace{-5pt}
        

\item{\textbf{LLM for Requirement Engineering} Developed an agentic system to auto-repair incomplete software requirement documents.}}

	\textbf{Key skills}: Requirements engineering, Information retrieval, RAG, Agentic framework, LangGraph 	  
        \vspace{-5pt}
  \resumeSubHeadingListEnd
...
\shorterSection{\textcolor{titleblue}{Skills}}
  \resumeSubHeadingListStart
      ...
      \resumeItemNoBullet{Programming Languages}{Rust, Python, Move, Solidity, C/C++, P }
      \resumeItemNoBullet{Framework and platforms}{LLVM, Linux, PyTorch, LangChain, LangGraph, HuggingFace}
      \resumeItemNoBullet{Experienced topics}{System Security, Blockchain Security, Fuzz Testing, Compiler Optimization, Programming Language Security, LLM application, RAG, Model Checking}
